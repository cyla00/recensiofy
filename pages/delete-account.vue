...
const deleteAccount = async () => {
    ...
    await $fetch('/api/users/delete', {method: 'delete', body, headers: {
    ...
    <main class="flex justify-center h-screen text-c-dark text-xs">
        ...
        <div class="m-auto">
            ...
            <div class="back-shadow p-10 rounded-xl max-md:px-5 max-md:w-4/5 m-auto w-forms">
                <div class="">
                    <h3 class="text-xl font-bold capitalize">permanently delete your account</h3>
                    <p class="font-medium mt-5 text-s">All your campaigns and reviews will be removed from the platform</p>
                </div>
