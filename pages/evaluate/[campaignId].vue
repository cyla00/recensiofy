...
const submitReview = async () => {
    ...
    await $fetch('/api/reviews/create', {method: 'post', body, headers: {
        Authorization: `Beader ${localStorage.getItem('token')}`,
    }}).then((res) => {
        Show.value = true
        ...
        <div class="m-auto w-[750px] max-md:w-4/5 shrink-0 my-20">
                ...
                <div class="mr-auto ml-5 overflow-hidden max-md:m-auto max-md:my-5 w-full my-auto">
                    ...
                    <div class="m-auto flex">
                        <p 
                            ...
                            class="my-2 duration-200 text-sm capizalize text-c-light py-1 px-3 bg-gradient-to-bl from-c-green to-c-blue font-bold rounded-full max-md:w-full max-md:mb-2 max-md:mx-0">
            ...
            <div class="back-shadow p-5 rounded-xl m-auto max-md:px-5">
                ...
                <div class="text-c-dark font-semibold text-base">
                    <h3 class="text-base">Rating *</h3>
                    <h3 class="text-xs">How good was it?</h3>
                    <RatingStars @ratingValue="(n) => {ratingNumber = n}"/>
                </div>

                <div class="flex flex-col my-3">
                    <div class="my-5">
                        <label class="text-base capitalize my-2 font-semibold m-0">title *</label>
                        <h3 class="font-semibold text-xs">Choose a title for your review</h3>
                    </div>
                    <input 
                    ...
                    <div class="my-5">
                        <label class="text-base capitalize my-2 font-semibold mt-10">description *</label>
                        <h3 class="font-semibold text-xs">Describe your experience</h3>
                    </div>
                    <textarea
